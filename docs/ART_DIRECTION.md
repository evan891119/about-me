...
## Museum Spatial Rules
- 空間主體是「單一大型主館」，不使用四間分散小屋作為主流程。
- 館內以四展區承接內容敘事：`intro -> skills -> projects -> contact`。
- 動線優先可讀性：入口後應能快速辨識中央走道與四展區方向。
- 建築尺度要明顯大於玩家體型，避免「模型小屋感」。
...
7. 夜晚不開手電筒也能辨識道路與建築輪廓。
8. 夜晚開手電筒後，8~12 公尺內互動目標清楚可見。
